...
class keyword.Chinese {
    ...
    public keyword.Chinese() {
    }

    public keyword.Chinese(String name, int age) {
        this.name = name;
        this.age = age;
    }
...
public class StaticTest {
    public static void main(String[] args) {
        keyword.Chinese c1 = new keyword.Chinese("康师傅", 36);
        c1.nation = "中华人民共和国";

        keyword.Chinese c2 = new keyword.Chinese("老干妈", 66);

        System.out.println(c1);
        System.out.println(c2);

        System.out.println(keyword.Chinese.nation);
    }
}
```
...
//    private static String country = "中国";
    ...
    public keyword.Chinese(String name) {
        this.name = name;
    }
}
```
...
public class TestStaticBlock {
    public static void main(String[] args) {
        keyword.Chinese c1 = new keyword.Chinese("张三");
        keyword.Chinese c2 = new keyword.Chinese("李四");
    }
}
...
c1[0]=new initialize.inheritance.Student("John","0001",20,85.0);
...
public class initialize.inheritance.Student {
    ...
    @Override
    public String toString() {
        return "initialize.inheritance.Student{" +
                "id=" + id +
                ", name='" + name + '\'' +
                '}';
    }
